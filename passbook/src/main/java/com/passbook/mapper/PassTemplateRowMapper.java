...
/*
*
* HBase PassTemplate Row To PassTamplate Object
* */
public class PassTemplateRowMapper implements RowMapper<PassTemplate> {
    ...
    private static byte[] BACKGROUND = Constants.PassTemplateTable.BACKGROUD.getBytes();
    ...
    public PassTemplate mapRow(Result result, int i) throws Exception {
       ...
       passTemplate.setBackgroud(Bytes.toInt(result.getValue(FAMILY_B, BACKGROUND)));
